...
export default function Transfer({logo,bankname,tick,h,w, styles} : TransferType) {
  ...
  useEffect(() => {
    ...
    check ? (trans.current as HTMLDivElement).style.background = "#c9cbcf" : (trans.current as HTMLDivElement).style.background = "white"
