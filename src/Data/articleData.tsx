import Spider from "../Assets/images/spider1.png";
...
const data = [
...

  {
    n2: {
      id: 2,
      title:
        "Facts About Yowis Ben Finale That You Need to Know Before Watching!2",
      img: Yow,
      date: "18 Feb 2021 | TIX ID",
      content:
        "Ultrices malesuada diam condimentum risus. In velit justo eu ac amet fusce lorem urna. Quis sed neque sed duis. Eleifend purus nam at cras nisi, vitae. Eleifend mollis sem odio morbi faucibus. Adipiscing in libero pharetra odio quam. Suspendisse tortor, viverra odio ultrices.Eu arcu odio neque ",
    },
  },
];
