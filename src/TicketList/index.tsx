          ...
          <div className='grid-secondcol'>
            ...
            <div className='movielist'>
              {option === 'flag' ? 
                  ...
                  : option === 'flag2' ? moviedata.map((elem)=> <MovTicketlst photu={elem.photu} moviename={elem.moviename} date={elem.date} theatre={elem.theatre} screen={elem.screen} done={elem.done} />) : ""}
